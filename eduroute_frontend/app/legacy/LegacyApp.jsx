...
import { clearAuthPayloadPublicKeyCache, encryptAuthPayload, encryptSensitivePayload, withFreshAuthPayloadKeyRetry } from '../../services/authPayloadEncryption';
...
function App() {
  ...
  const loginApi = async payload => withFreshAuthPayloadKeyRetry(async () => apiRequest('/api/auth/login', {
    method: 'POST',
    body: JSON.stringify(await encryptAuthPayload(payload))
  }));
