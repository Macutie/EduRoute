...
import { GORDON_COLLEGE_EMAIL_DOMAIN } from "../shared/appUtils.js";

const normalizeInstitutionalLogin = value => {
  const identifier = String(value || '').trim().toLowerCase();
  return identifier && !identifier.includes('@') ? `${identifier}${GORDON_COLLEGE_EMAIL_DOMAIN}` : identifier;
};
                ...
                <div className="dlogin-form-body">
                  <div className="dlogin-input-group">
                    ...
                    <div className="dlogin-input-wrapper">
                      ...
                      <input type="text" inputMode="email" autoComplete="username" placeholder="e.g. admin.01" value={loginForm.email_or_employee_id} onChange={e => setLoginForm(prev => ({
                        ...prev,
                        email_or_employee_id: e.target.value
                      }))} onBlur={e => setLoginForm(prev => ({
                        ...prev,
                        email_or_employee_id: normalizeInstitutionalLogin(e.target.value)
                      }))} />
                    </div>
                    <p className="login-identifier-hint">Enter your email name only. <strong>@gordoncollege.edu.ph</strong> is added automatically.</p>
                  </div>
          ...
          <div className="login-form-body">
            <div className="input-group">
              ...
              <div className="input-wrapper">
                <BadgeIcon />
                <input type="text" inputMode="email" autoComplete="username" placeholder="j.smith" value={loginForm.email_or_employee_id} onChange={e => setLoginForm(prev => ({
                  ...prev,
                  email_or_employee_id: e.target.value
                }))} onBlur={e => setLoginForm(prev => ({
                  ...prev,
              ...
              <p className="login-identifier-hint">Enter your username only. <strong>@gordoncollege.edu.ph</strong> is added automatically.</p>
            </div>
