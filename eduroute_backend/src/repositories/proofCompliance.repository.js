...
const buildProofSelect = async (client = pool, { alias = 'verification' } = {}) => {
    ...
    return `
        ...
        ${selectColumn('focal_person_company', 'NULL::text')},
        ${selectColumn('focal_person_company_encrypted', 'NULL::text')},
        ${selectColumn('focal_person_company_iv', 'NULL::text')},
        ${selectColumn('focal_person_company_auth_tag', 'NULL::text')},
...
const mapProofRow = (row) => {
    ...
    return {
        ...
        focalPersonCompany: decryptFieldFromRow(row, 'focal_person_company'),
...
const insertProof = async (payload, client = pool) => {
    ...
    const supportedColumns = [
        ...
        ...buildEncryptedTextColumnEntries(columns, 'focal_person_company', payload.focalPersonCompany),
